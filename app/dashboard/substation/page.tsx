...
import { Search, Info, MoveLeft, MoveRight, SquarePlus } from "lucide-react";
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-semibold">Substation</h2>
        <Link
          href="/dashboard/substation/create"
          className="flex items-center space-x-2 px-4 py-2 rounded-md text-sm text-white bg-neutral-800 hover:bg-gray-100 hover:text-gray-500"
        >
          <SquarePlus size={16} />
